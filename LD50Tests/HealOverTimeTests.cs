...
namespace LD50Tests
{
    public class HealOverTimeTests
    {
        ...
        public void heal_over_time_works_non_incrementally_big_numbers()
        {
            ...
            var statusAfterOneSecond = status.GetNext(1f, 0, 0, 0);
            var statusAfterTwoSeconds = status.GetNext(2f, 0, 0, 0);
            var statusAfterThreeSeconds = status.GetNext(3f, 0, 0, 0);
        ...
        public void heal_over_time_works_non_incrementally_small_numbers()
        {
            ...
            var oneSecond = status.GetNext(1f, 0, 0, 0);
            var oneAndAHalfSeconds = status.GetNext(1.5f, 0, 0, 0);
            var twoSeconds = status.GetNext(2f, 0, 0, 0);
        ...
        public void heal_over_time_works_incrementally_big_numbers()
        {
            ...
            var statusAfterOneSecond = status.GetNext(1f, 0, 0, 0);
            var statusAfterTwoSeconds = statusAfterOneSecond.GetNext(1f, 0, 0, 0);
            var statusAfterThreeSeconds = statusAfterTwoSeconds.GetNext(1f, 0, 0, 0);
        ...
        public void heal_over_time_works_incrementally_small_numbers()
        {
            ...
            var halfSecond = status.GetNext(0.5f, 0, 0, 0);
            var oneSecond = halfSecond.GetNext(0.5f, 0, 0, 0);
            var oneAndAHalfSeconds = oneSecond.GetNext(0.5f, 0, 0, 0);
            var twoSeconds = oneAndAHalfSeconds.GetNext(0.5f, 0, 0, 0);
